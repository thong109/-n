<?php
  ...
  session_start();
    ...
    if($nums>0){
      ...
      echo "<script>alert('Đăng nhập thành công, chào mừng quản trị viên!!!');location.href='index.php'</script>";
    }else{
      echo "<script>alert('Sai email hoặc mật khẩu, hãy nhập lại !!!');location.href='login.php'</script>"; 
    }
  }
?>
<style>
