<footer class="py-4 bg-light mt-auto">
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between small">
            ...
            <div class="text-muted">Email : thong.phan109@gmail.com <br>Sđt : 0778960401</div>
...
<script src="https://code.jquery.com/jquery-3.5.1.min.js" crossorigin="anonymous"></script>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
  <script src="<?php echo base_url() ?>public/admin/assets/demo/chart-area-demo.js"></script>
   ...
   <script src="<?php echo base_url() ?>public/admin/assets/demo/chart-pie-demo.js"></script> </body> </html>