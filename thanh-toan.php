...
<body>
<!-- Form Wrapper -->
<link rel="stylesheet" type="text/css" href="/web_ban_hang/public/frontend/css/thanh-toan.css">
<script  src="/web_ban_hang/public/frontend/js/thanh-toan.js"></script>
...
<input type='text'  name="note" placeholder='Ghi chú ...' id='note' class='note'value="">
<div id="form-submit">
